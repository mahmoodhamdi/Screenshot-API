...
export const icons = {
  camera: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="20" height="14" rx="2"/><circle cx="12" cy="10" r="3"/><path d="M5 21L12 17L19 21"/></svg>`,
...
export function getIcon(name: keyof typeof icons, className = ''): string {
